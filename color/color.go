...
var (
	...
	DiscreteRainbow = &Scheme{
		...
		Colors: []*Color{
			NewColor(Black, 0xE8, 0xEC, 0xFB, "no. 1"),
			NewColor(Black, 0xD9, 0xCC, 0xE3, "no. 2"),
			NewColor(Black, 0xD1, 0xBB, 0xD7, "no. 3"),
			NewColor(Black, 0xCA, 0xAC, 0xCB, "no. 4"),
			NewColor(Black, 0xBA, 0x8D, 0xB4, "no. 5"),
			NewColor(Black, 0xAE, 0x76, 0xA3, "no. 6"),
			NewColor(Black, 0xAA, 0x6F, 0x9E, "no. 7"),
			NewColor(Black, 0x99, 0x4F, 0x88, "no. 8"),
			NewColor(Black, 0x88, 0x2E, 0x72, "no. 9"),
			NewColor(Black, 0x19, 0x65, 0xB0, "no. 10"),
			NewColor(Black, 0x43, 0x7D, 0xBF, "no. 11"),
			NewColor(Black, 0x52, 0x89, 0xC7, "no. 12"),
			NewColor(Black, 0x61, 0x95, 0xCF, "no. 13"),
			NewColor(Black, 0x7B, 0xAF, 0xDE, "no. 14"),
			NewColor(Black, 0x4E, 0xB2, 0x65, "no. 15"),
			NewColor(Black, 0x90, 0xC9, 0x87, "no. 16"),
			NewColor(Black, 0xCA, 0xE0, 0xAB, "no. 17"),
			NewColor(Black, 0xF7, 0xF0, 0x56, "no. 18"),
			NewColor(Black, 0xF7, 0xCB, 0x45, "no. 19"),
			NewColor(Black, 0xF6, 0xC1, 0x41, "no. 20"),
			NewColor(Black, 0xF4, 0xA7, 0x36, "no. 21"),
			NewColor(Black, 0xF1, 0x93, 0x2D, "no. 22"),
			NewColor(Black, 0xEE, 0x80, 0x26, "no. 23"),
			NewColor(Black, 0xE8, 0x60, 0x1C, "no. 24"),
			NewColor(Black, 0xE6, 0x55, 0x18, "no. 25"),
			NewColor(Black, 0xDC, 0x05, 0x0C, "no. 26"),
			NewColor(Black, 0xA5, 0x17, 0x0E, "no. 27"),
			NewColor(Black, 0x72, 0x19, 0x0E, "no. 28"),
			NewColor(Black, 0x42, 0x15, 0x0A, "no. 29"),
		},
